...
public class RenderPlesiosaur extends RenderLiving
{
            ...
            float f, float f1)
    {
         ...
         try
         {
              ...
              float var15 = entityPlesiosaur.prevLegYaw + (entityPlesiosaur.legYaw - entityPlesiosaur.prevLegYaw) * f1;
              float var16 = entityPlesiosaur.legSwing - entityPlesiosaur.legYaw * (1.0F - f1);
