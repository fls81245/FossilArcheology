...
public class RenderTriceratops extends RenderLiving
{
            ...
            float f, float f1)
    {
        ...
        try
        {
             ...
             float var15 = entityTriceratops.prevLegYaw + (entityTriceratops.legYaw - entityTriceratops.prevLegYaw) * f1;
             float var16 = entityTriceratops.legSwing - entityTriceratops.legYaw * (1.0F - f1);
	...
	protected int shouldRenderPass(EntityLiving entityliving, int i, float f)
    {
        ...
        if (triceratops.health<(8+triceratops.getDinoAge()) && triceratops.health>20){
			loadTexture("/skull/Tri_Hurt.png");
			return 1;
		}
		return -1;
    }
